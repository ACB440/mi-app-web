...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($titulo) || empty($puntuacion) || empty($id_plataforma)) {
        ...
        try {
            ...
            if ($stmt->execute()) {
                $mensaje = '<div class="alert alert-success">Juego añadido correctamente. <a href="ranking.php">Ver ranking</a></div>';
            } else {
        ...
        <section class="form-section">
            <div class="form-card">
                <div class="section-header">
                    ...
                    <a href="ranking.php" class="btn btn-secondary">Volver</a>
                </div>

                <?php echo $mensaje; ?>

                <form action="formulario.php" method="POST" class="game-form">
