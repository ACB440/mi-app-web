...
<body>
    ...
    <header>
        <div class="container">
            <h1><a href="inicio.php" style="text-decoration: none; color: inherit;">Game<span>Rank</span></a></h1>
        ...
        <section class="ranking-section">
            <div class="section-header">
                ...
                <div style="display: flex; gap: 1rem; align-items: center;">
                    <a href="formulario.php" class="btn">Añadir Juego</a>
            ...
            <div class="ranking-grid">
                ...
                <?php foreach ($juegos as $index => $juego): ?>
                    ...
                    ?>
                    <div class="game-card" id="game-<?php echo $index; ?>" onclick="window.location.href='detalle.php?id=<?php echo $juego['id']; ?>'" style="cursor: pointer;">
                        <img
                        ...
                        <div class="game-info">
                            <h3 class="game-title">
                                <a href="detalle.php?id=<?php echo $juego['id']; ?>" style="text-decoration: none; color: inherit;">
